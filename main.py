...
from route_agent import RouteAgentToolbox  # your wrapper around route_tools
...
# main.py (only showing the bottom part)
    ...
    tools = RouteAgentToolbox()

    tools.register(caller=route_agent, executor=user)

    query = (
        "Get fastest driving route from '10 Carlson Ave, Clayton VIC' to '20 Kings College Dr, Bayswater VIC 3153'. "
        "Return: summary, leg distance/duration, overview polyline, and a road-snapped polyline."
    )
